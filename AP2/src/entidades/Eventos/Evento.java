...
abstract public class Evento {
    ...
    private int ingressosInteiraCurrent;
    private int ingressosMeiaCurrent;
    ...
    public void atualizarDados(String localNovo, LocalDate dataNova){
        local = localNovo;
        data = dataNova;
    }
    ...
    public String toString(){
        return this.nome + "\n"+
            "Data: " + this.data +
            "\nLocal: " + this.local + 
            "\nNumero de inteiras restantes: " + this.ingressosInteiraCurrent + 
            "\nNumero de meias restantes: " + this.ingressosMeiaCurrent +
